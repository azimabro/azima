...
export default function MbtiBlogPostPage() {
  ...
  const articleSchema = {
    ...
    url: `https://haltsp.com/en/mbti/blog/${post.slug}`,
  ...
  return (
    <div className="min-h-screen bg-gray-50 page-enter">
      <SeoHead
        title={post.title}
        description={post.description}
        canonical={`https://haltsp.com/en/mbti/blog/${post.slug}`}
        schema={articleSchema}
      />
      <Breadcrumb items={[
        { name: 'Home', url: 'https://haltsp.com/en' },
        { name: 'MBTI Test', url: 'https://haltsp.com/en/mbti' },
        { name: post.title, url: `https://haltsp.com/en/mbti/blog/${post.slug}` },
      ]} />
      <div className="max-w-lg mx-auto w-full">
        ...
        <div className="bg-gradient-to-br from-primary to-primary-dark px-5 pt-10 pb-12 text-white">
          <p className="text-sm text-white/60 mb-2">MBTI Knowledge · In-Depth</p>
        ...
        <div className="px-5 pb-10 text-center">
          <div className="bg-primary/5 rounded-2xl p-6 border border-primary/10">
            ...
            <h3 className="text-base font-bold text-primary-dark mb-2">
              Know Yourself — Start With Your Personality Type
            </h3>
            <p className="text-sm text-gray-500 mb-4">
              5 minutes to discover your 4-letter type
            </p>
            <Link
              to="/en/mbti/test"
            ...
            <p className="text-xs text-gray-400 mt-3">
              Based on MBTI Framework · Free · No Sign-Up
            </p>
          </div>
          ...
          <div className="mt-6 space-y-2">
            <Link to="/en/mbti" className="block text-sm text-primary underline underline-offset-4 hover:text-primary-dark">
              Back to MBTI Home →
            </Link>
