        ...
        <div className="px-5 pb-8 space-y-4 -mt-4">
          {post.sections.map((section, i) => (
            <React.Fragment key={i}>
              <BlogSection section={section} ctaHtml="Based on Dr. Elaine Aron's HSP Scale<br /><strong>23 Questions · 3 Minutes · 4-Dimension Analysis</strong>" ctaButton="Start Free Test →" testPath="/en/test" />
              {i === 1 && (
                <div className="px-0">
