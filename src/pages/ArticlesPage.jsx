...
const faq = [
  ...
  {
    question: '高敏感是天生的吗？会遗传吗？',
    answer: '是的。研究表明确实存在遗传基础——HSP 相关的神经系统敏感度在家族中有聚集现象。fMRI 研究也发现高敏感者的大脑在处理信息时激活区域更广。但后天环境同样重要：童年经历、成长环境会影响你如何与自己的敏感度共处。',
  },
  {
    question: '高敏感和焦虑症有什么关系？',
    answer: '高敏感不是焦虑症，但高敏感者在高压环境中确实更容易产生焦虑。原因在于：神经系统对刺激更敏感 → 更容易达到过载状态 → 长期过载容易诱发焦虑。关键在于：高敏感本身不是问题，但没有好的自我管理策略，它可能发展成焦虑。提前建立能量管理习惯是最好的预防。',
  },
  {
    question: '高敏感者如何处理人际冲突？',
    answer: '高敏感者天然回避冲突，因为冲突带来的情绪冲击比常人更大。建议：① 不要在情绪过载时沟通——先冷静，再对话；② 用"我感觉……"句式表达而不是指责对方；③ 提前设定边界，而不是等到忍无可忍；④ 接受"不是所有冲突都需要当下解决"——给自己争取消化时间是可以的。',
  },
  {
    question: '高敏感者怎么提高睡眠质量？',
    answer: '高敏感者更容易因感官刺激（光线、声音、床品质感）和环境变化而失眠。改善方法：① 遮光窗帘 + 白噪音机创造"感官屏蔽"环境；② 睡前 1 小时停止屏幕使用——蓝光和信息的双重刺激是睡眠杀手；③ 建立固定的睡前仪式（泡脚、冥想、轻音乐）；④ 床品选高支数纯棉或丝绸，减少触觉刺激。',
  },
  {
    question: '高敏感者适合什么样的伴侣？',
    answer: '最关键的三个特质：① 尊重你独处的需求——不会把你的"我需要一个人待会儿"解读为拒绝；② 沟通方式温和——不会用讽刺、冷暴力或突然爆发来处理矛盾；③ 情绪稳定——不需要你一直做情绪上的照顾者。内向者或同样高敏感的伴侣通常彼此理解更深，但外向者有他们的互补优势。',
  },
  {
    question: '我的孩子可能是高敏感，怎么办？',
    answer: '首先，高敏感不是问题，不需要"矫正"。养育高敏感孩子的核心原则：① 接纳他们的情绪强度——不要用"别哭了，这有什么好哭的"否定他们的感受；② 给他们足够的安静恢复时间——放学后不要马上安排活动；③ 提前预告变化——高敏感孩子对突然的改变反应强烈；④ 赞扬他们的敏感带来的优势：共情力、观察力、创造力。',
  },
  {
    question: '高敏感者在职场如何避免消耗？',
    answer: '① 如果可以，选择远程或混合办公——减少开放式办公室的感官轰炸；② 用降噪耳机为自己创造"感官屏蔽"时段；③ 把需要深度专注的工作放在上午（精力最充足的时候）；④ 学会在会议间给自己 5-10 分钟的缓冲时间；⑤ 如果你的高敏感是一种职场优势（细节把控、风险预判、人际洞察），别藏着——让上级知道这是你的价值。',
  },
  {
    question: '高敏感者有什么优势？',
    answer: '① 深度共情——你能感受到别人没说出口的情绪，这让你成为更好的伴侣、朋友和倾听者；② 细节洞察——你注意到别人忽略的细节，这在工作中意味着更少的失误；③ 深度思考——你不满足于表面答案，这种习惯带来更周全的决策；④ 审美敏感——你对美和品质有天然的判断力；⑤ 风险预判——你比大多数人更早发现潜在问题。目标不是变"钝"，而是在保护自己不被过度刺激的同时，充分运用这些优势。',
  },
];
